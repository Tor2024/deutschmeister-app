...
export const MOCK_LESSONS: Lesson[] = [
  // --- A1 ---
  // Grammatik & erste Lexik
  lessonA1AlphabetBegruessungen,
  lessonA1PersonalpronomenSeinHaben,
  lessonA1LexikPersoenlicheInfos, // Lexik nach Pronomen
  lessonA1ArtikelGenus,
  lessonA1Pluralbildung,
  lessonA1GrammatikPraesensVerben, // Grammatik: Präsens
  ...
  lessonB1PartizipienAlsAdjektive, // New B1 Grammar
