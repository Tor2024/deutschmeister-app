...
**2. Простые придаточные предложения (Nebensätze) на уровне А2:**
Придаточные предложения обычно вводятся союзами и зависят от главного предложения.
...
*   **С модальными глаголами в придаточном:** Модальный глагол (спрягаемая форма) идет в конец, инфинитив смыслового глагола стоит перед ним.
    *Пример: Er sagt, dass er gut singen **kann**. (Он говорит, что умеет хорошо петь.)*
*   **В Perfekt в придаточном:** Вспомогательный глагол (haben/sein в спрягаемой форме) идет в конец, Partizip II стоит перед ним.
    *Пример: Sie freut sich, weil sie die Prüfung bestanden **hat**. (Она радуется, потому что сдала экзамен.)*
*   **С отделяемыми приставками в придаточном:** В придаточном предложении отделяемая приставка **не отделяется** от глагола, и глагол целиком стоит в конце.
...
Понимание этих правил необходимо для построения грамматически правильных и понятных немецких предложений.
`,
  vocabulary: [
