...
Запоминание спряжения \`werden\` и правильная постановка инфинитива в конец предложения – ключ к использованию Futur I.`,
  ...
  exercises: [
    ...
    },
    {
      id: 'b1-futur1-ex6',
      type: 'translation',
      question: 'Переведите на немецкий: "Завтра будет дождь."',
      prompt: 'Завтра будет дождь.',
      languageDirection: 'to_german',
      correctAnswer: 'Morgen wird es regnen.',
      explanation: 'Прогноз погоды часто выражается через Futur I.'
    },
    {
      id: 'b1-futur1-ex7',
      type: 'multiple_choice',
      ...
      options: [
        'Sie wird das Buch lesen morgen.',
        'Sie wird morgen lesen das Buch.',
        'Sie wird morgen das Buch lesen.'
      ],
      correctAnswer: 'Sie wird morgen das Buch lesen.',
      explanation: 'В Futur I смысловой инфинитив ("lesen") всегда стоит в самом конце главного предложения.'
    }
  ],
};
