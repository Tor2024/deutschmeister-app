...
export interface ReadingComprehensionQuestion {
  id: string; // e.g., lessonId-rq-1
  question: string; // Вопрос на русском или немецком
  options: string[]; // Варианты ответа
  correctAnswer: string; // Правильный вариант ответа (текст)
...
export interface Lesson {
  ...
  readingText?: string; // Text for reading comprehension
  readingComprehensionExercises?: ReadingComprehensionQuestion[]; // Questions for reading comprehension
}
